...
class CheckAuthenticationPresenter(val mListener:ValidateDataListener<CodeApiModel>): KoinComponent {
    fun authenticationData(mobile:String, code:String){
        ...
        if (network.isNetworkAvailable(MainActivity.mContext)){
            ...
            apiServices
                .getApi()
                .checkAuthenticationCode(MainActivity.mContext.checkCodeUrl, CheckCodeModel(mobile, code))
